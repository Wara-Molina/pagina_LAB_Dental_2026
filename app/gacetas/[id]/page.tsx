      ...
      <div className="min-h-screen flex flex-col bg-gray-50">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/gacetas" className="text-blue-600 hover:underline font-medium">← Volver</Link>
          </div>
        </div>
        <Footer />
      </div>
      ...
      <div className="min-h-screen flex flex-col" style={{ background: `linear-gradient(135deg, ${hexToRgba(primaryColor, 0.1)}, ${hexToRgba(secondaryColor, 0.1)})` }}>
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="text-center max-w-md">
            ...
            <Link href="/gacetas" className="inline-flex items-center gap-2 px-8 py-3 rounded-full font-medium text-white shadow-lg hover:shadow-xl transition-all" style={{ backgroundColor: primaryColor }}>
          ...
          <div className="max-w-6xl mx-auto px-4">
            {documentoUrl ? (
              ...
              <div className="bg-white rounded-2xl border shadow-xl p-12 text-center" style={{ borderColor: `${hexToRgba(primaryColor, 0.2)}` }}>
                ...
                <p className="text-gray-600 mb-6">Este registro no tiene un archivo PDF adjunto.</p>
                <Link href="/gacetas" className="inline-flex items-center gap-2 px-6 py-3 rounded-full font-medium text-white shadow-lg hover:shadow-xl transition-all" style={{ backgroundColor: primaryColor }}>
              ...
              <div className="bg-white rounded-2xl border shadow-lg p-6 md:p-8" style={{ borderColor: `${hexToRgba(primaryColor, 0.2)}` }}>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <div className="p-4 rounded-xl bg-gray-50">
                    ...
                    <p className="font-medium text-gray-900">{gaceta.gaceta_tipo || 'General'}</p>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-gray-50">
                    <p className="text-xs font-semibold uppercase tracking-wide mb-2" style={{ color: `${hexToRgba(primaryColor, 0.7)}` }}>Formato</p>
          ...
          >
            ...
            <div className="absolute bottom-8 left-0 right-0 text-center pointer-events-none">
              <p className="text-white text-lg font-semibold bg-black/60 backdrop-blur-md inline-block px-6 py-3 rounded-full">
                <FileText className="w-5 h-5 inline mr-2" /> {gaceta.gaceta_titulo}
              </p>
            </div>
          </div>
        )}
