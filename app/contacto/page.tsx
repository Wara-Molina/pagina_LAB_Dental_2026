...
function ContactoContent() {
    ...
    const fetchData = async () => {
      try {
        ...
        if (instData.colorinstitucion?.[0]) {
          ...
          setSecondaryColor(
            getSafeColor(
              instData.colorinstitucion[0].color_secundario,
              "#FC0102",
            ),
          );
          setTertiaryColor(
  ...
  const safeMapsUrl = validateGoogleMapsUrl(
            ...
            <div className="grid grid-cols-1 xl:grid-cols-7 gap-8">
              ...
              <div className="xl:col-span-3">
                ...
                {socialLinks.length > 0 && (
                  <div
                    className="lg:col-span-2 bg-white rounded-2xl border shadow-lg overflow-hidden"
