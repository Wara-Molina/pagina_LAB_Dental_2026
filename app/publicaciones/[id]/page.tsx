...
function PublicacionDetalleContent() {
  ...
  const publicacionId =
    Number.isInteger(rawPublicacionId) &&
    rawPublicacionId > 0 &&
    rawPublicacionId < 10000000
      ? rawPublicacionId
      : null;
    ...
    const fetchPublicacion = async () => {
      try {
        ...
        setPublicacion({
          ...
          publicaciones_titulo: sanitizeHTML(
            publicacionEncontrada.publicaciones_titulo || "Sin título",
          ),
          publicaciones_imagen: publicacionEncontrada.publicaciones_imagen,
          publicaciones_descripcion:
            publicacionEncontrada.publicaciones_descripcion,
          publicaciones_documento:
            publicacionEncontrada.publicaciones_documento,
          publicaciones_fecha: publicacionEncontrada.publicaciones_fecha,
          publicaciones_autor: sanitizeHTML(
            publicacionEncontrada.publicaciones_autor || "",
          ),
          publicaciones_tipo: sanitizeHTML(
            publicacionEncontrada.publicaciones_tipo || "",
          ),
        });
  ...
  const handleShare = async () => {
    ...
    const safeDescription = sanitizeForShare(
        ...
        >
          {publicacion.publicaciones_imagen && imageUrl ? (
            ...
            <div
              ...
              style={{
                background: `linear-gradient(135deg, ${hexToRgba(primaryColor, 0.8)}, ${hexToRgba(tertiaryColor, 0.9)})`,
              }}
            >
          ...
          <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              >
                {/* Metadata */}
                <div
                  className="flex flex-wrap gap-6 mb-8 pb-6 border-b"
                  style={{ borderColor: `${hexToRgba(primaryColor, 0.2)}` }}
                >
                ...
                <div className="space-y-4 mb-10">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <button
                            ...
                            style={{ backgroundColor: primaryColor }}
                          >
                            <Maximize2 className="w-4 h-4" /> Ver imagen
                            completa
                          </button>
                        </div>
                      </div>
                  ...
                  {publicacion.publicaciones_documento && pdfUrl && (
                    <div
                      ...
                      tabIndex={0}
                      onKeyDown={(e) =>
                        e.key === "Enter" && setPdfModalOpen(true)
                      }
                      style={{
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">
                      {publicacion.publicaciones_tipo || "General"}
                    </p>
                  </div>
