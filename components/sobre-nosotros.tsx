  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setData({
          institucion: res?.data?.Descripcion || null,
        });
      } catch {
...
const SobreNosotrosDefault = memo(function SobreNosotrosDefault({
  data,
  primaryColor,
  secondaryColor,
  tertiaryColor,
  ...
  setActiveTab: (tab: "mision" | "vision") => void;
  ...
  const misionText =
    extractPlainText(data.institucion?.institucion_mision || "") ||
    "Información institucional próximamente disponible.";

  const visionText =
    extractPlainText(data.institucion?.institucion_vision || "") ||
    "Información institucional próximamente disponible.";
          ...
          <div className="lg:col-span-7">
            ...
            <div className="mb-10">
              <p className="text-slate-700 leading-relaxed text-lg whitespace-pre-line">
                {activeTab === "mision" ? misionText : visionText}
              </p>
            </div>
...
const SobreNosotrosDental = memo(function SobreNosotrosDental({
  data,
  primaryColor,
  secondaryColor,
  tertiaryColor,
  ...
  const logoUrl = sanitizeImageUrl(data.institucion?.institucion_logo);
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <div className="space-y-6">
              <div className="rounded-[32px] border border-slate-200 bg-white backdrop-blur-2xl p-8 shadow-2xl">
                ...
                <p className="text-slate-600 leading-relaxed">{mision}</p>
              </div>
          ...
          <div className="relative overflow-visible min-h-[700px] flex items-center justify-center">
            ...
            <div className="absolute bottom-[30px] -left-[40px] z-[60] rounded-[30px] border border-slate-200 bg-white backdrop-blur-2xl shadow-[0_25px_80px_rgba(0,0,0,0.45)] p-6 w-[260px]">
